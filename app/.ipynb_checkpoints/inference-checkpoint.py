	...
	def run_inference(self, image, debug_image):
                           ...
                           if results.multi_hand_landmarks is not None :
                               for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                                   ...
                                   landmark_list, landmark_list_z = calc_landmark_list(debug_image, hand_landmarks)
                        
                                   pre_processed_landmark_list, pre_processed_landmark_list_z = pre_process_landmark(
                                       landmark_list, landmark_list_z, self.verbose)
                                   ...
                                   #TODO: save only last 100 points to keep memory footprint low 
...
def calc_landmark_list(image, landmarks):
    ...
    return landmark_point, landmark_point_z
